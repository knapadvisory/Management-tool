...
- The **Files** tab has two sub-tabs: **Shared files** (everything shared across your conversations and tasks) and **Drive**
- A **People** tab combines the **Team** directory and **Collabs** under one place, with a sub-tab switch
